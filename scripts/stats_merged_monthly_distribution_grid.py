#!/usr/bin/env python3
"""Plot monthly event-count distributions from run merged CSV files.
...
MONTH_FORMAT = "%Y-%m"
FILE_PATTERNS = "run_merged_event_count_daily_{start}_{end}.csv"
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Read monthly run_merged_event_count CSV files and plot a 3x3 monthly "
    ...
    parser.add_argument(
        "--reco-dir",
        default="../Reco_Dir",
        help="Directory containing run_merged_event_count CSV files",
    )
    parser.add_argument(
        "--start-month",
        type=parse_month,
    ...
    parser.add_argument(
        "--output-png",
        default="../Reco_Dir/run_merged_event_count_monthly_202507_202603_grid.png",
